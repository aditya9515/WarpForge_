...
- [Hosted CPU workflow](../.github/workflows/cpu.yml): Windows and Linux compile/test the CPU-only mode, check Python syntax and repository links/JSON, and verify the committed release plot. These jobs make no GPU claim.
